...
var Post = function (_Component) {
  ...
  function Post() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Post.__proto__ || Object.getPrototypeOf(Post)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.props.onEdit(_this.state.postData.title, _this.state.postData.description);
      _this.setState({ edit: false });
    }, _this.cancel = function () {
      _this.setState({ edit: false });
      _this.state.postData.title = _this.props.title;
      _this.state.postData.description = _this.props.description;
    }, _this.handleInput = function (event, name) {
      var newPostData = _extends({}, _this.state.postData);
      newPostData[name] = event.target.value;
      _this.setState({ postData: newPostData });
    }, _this.renderInit = function () {
      return _react2.default.createElement(
        "tr",
        { className: "table-posts__row table__row-body" },
        _react2.default.createElement(
          "td",
          { className: "table-posts__cell table-posts__cell-body" },
          _this.props.index
        ),
        _react2.default.createElement(
          "td",
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "button",
            { className: "btn btn_del", onClick: _this.props.onDelete },
            "delete"
          ),
          _react2.default.createElement(
            "button",
            { className: "btn btn_edit", onClick: _this.edit },
            "edit"
          )
        )
      );
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement("input", {
            value: _this.state.postData.title,
            onChange: function onChange(event) {
              return _this.handleInput(event, 'title');
            }
          })
        ),
        _react2.default.createElement(
          ...
          { className: "table-posts__cell table-posts__cell-body" },
          _react2.default.createElement("input", {
            value: _this.state.postData.description,
            onChange: function onChange(event) {
              return _this.handleInput(event, 'description');
            }
          })
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "button",
            { className: "btn btn_save", onClick: _this.save },
            "Ok"
          ),
          _react2.default.createElement(
            "button",
            { className: "btn btn_cancel", onClick: _this.cancel },
            "Cancel"
          )
        )
      );
...
var PostEditor = function (_Component) {
  ...
  function PostEditor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PostEditor.__proto__ || Object.getPrototypeOf(PostEditor)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      postData: {
        title: '',
        description: ''
      },
      ...
      newPostData[name] = event.target.value;
      _this.setState({ postData: newPostData });
    }, _this.handlePostAdd = function () {
      var newPost = {
        id: (0, _v2.default)(),
        title: _this.state.postData.title,
        description: _this.state.postData.description

      };
      _this.props.onPostAdd(newPost);
      _this.state.postData.title = '';
      _this.state.postData.description = '';
    }, _this.add = function () {
      _this.setState({ add: true });
    }, _this.save = function () {
      ...
      return _react2.default.createElement(
        'header',
        { className: 'todo-component__header' },
        _react2.default.createElement(
          'h1',
          { className: 'todo-component__header-title' },
          'posts'
        ),
        _react2.default.createElement(
          'button',
          { className: 'btn btn_add', onClick: _this.add },
          'create'
        )
      );
    }, _this.renderAdd = function () {
      return _react2.default.createElement(
        'header',
        { className: 'todo-component__header' },
        _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { className: 'btn btn_save', onClick: _this.handlePostAdd },
            'Ok'
          ),
          _react2.default.createElement(
            'button',
            { className: 'btn btn_cancel', onClick: _this.save },
            'Cancel'
          )
        )
      );
...
var _PostsList = __webpack_require__(/*! ./PostsList */ "./src/components/PostsList.jsx");

var _PostsList2 = _interopRequireDefault(_PostsList);

var _PostEditor = __webpack_require__(/*! ./PostEditor */ "./src/components/PostEditor.jsx");
...
var PostsApp = function (_Component) {
  _inherits(PostsApp, _Component);
  ...
  function PostsApp() {
    ...
    _classCallCheck(this, PostsApp);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PostsApp.__proto__ || Object.getPrototypeOf(PostsApp)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      posts: []
      // is invoked immediately after a component is mounted
    }, _this.componentDidMount = function () {
      var localPosts = JSON.parse(localStorage.getItem('posts'));
      if (localPosts) {
        _this.setState({ posts: localPosts });
      }
    }, _this.componentDidUpdate = function () {
      return _this._updateLocalStorage();
    }, _this._updateLocalStorage = function () {
      var posts = JSON.stringify(_this.state.posts);
      localStorage.setItem('posts', posts);
    }, _this.handlePostAdd = function (newPost) {
      // create a copy posts
      var newPosts = _this.state.posts.slice();
      newPosts.unshift(newPost);
      _this.setState({ posts: newPosts });
    }, _this.handlePostDel = function (post) {
      var postId = post.id;
      var newPosts = _this.state.posts.filter(function (post) {
        return post.id !== postId;
      });
      _this.setState({ posts: newPosts });
    }, _this.handlePostEdit = function (post) {
      var newPosts = _this.state.posts.slice();
      var index = newPosts.findIndex(function (storedPost) {
        return storedPost.id === post.id;
      });
      newPosts[index].title = arguments.length <= 1 ? undefined : arguments[1];
      newPosts[index].description = arguments.length <= 2 ? undefined : arguments[2];
      _this.setState({ posts: newPosts });
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(PostsApp, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'todo-component__wrapper' },
          _react2.default.createElement(_PostEditor2.default, {
...
var _Post = __webpack_require__(/*! ./Post */ "./src/components/Post.jsx");
...
var PostsList = function (_Component) {
  ...
  _createClass(PostsList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'article',
        { className: 'todo-component__posts' },
        _react2.default.createElement(
          'div',
          { className: 'todo-component__posts-table' },
          _react2.default.createElement(
            'table',
            { className: 'table-posts' },
            _react2.default.createElement(
              'thead',
              { className: 'table-posts__head' },
              _react2.default.createElement(
                'tr',
                { className: 'table-posts__row table-posts__row-head' },
                _react2.default.createElement(
                  'th',
                ...
                _react2.default.createElement(
                  'th',
                  { colSpan: '2', className: 'table-posts__cell table-posts__cell-head' },
                  'Action'
                )
              )
            ),
              ...
              this.props.posts.map(function (post, i) {
                return _react2.default.createElement(_Post2.default, {
                  ...
                  onDelete: function onDelete() {
                    return _this2.props.onPostDelete(post);
                  },
                  onEdit: function onEdit() {
                    ...
                    return (_props = _this2.props).onPostEdit.apply(_props, [post].concat(data));
                  }
                });
              })
            )
...
var _PostsApp = __webpack_require__(/*! ./components/PostsApp */ "./src/components/PostsApp.jsx");
...
var App = function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_PostsApp2.default, null)
    ),
